...
class PlanningGraph():
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        intersect1 = set(node_a1.action.effect_add) & set(node_a2.action.effect_rem)
        intersect2 = set(node_a2.action.effect_add) & set(node_a1.action.effect_rem)

        return bool(intersect1) or bool(intersect2)
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        ab_pos = set(node_a1.action.effect_add) & set(node_a2.action.precond_neg)
        ab_neg = set(node_a1.action.effect_rem) & set(node_a2.action.precond_pos)
        ba_pos = set(node_a2.action.effect_add) & set(node_a1.action.precond_neg)
        ba_neg = set(node_a2.action.effect_rem) & set(node_a1.action.precond_pos)

        return bool(ab_pos) or bool(ab_neg) or bool(ba_pos) or bool(ba_neg)
    ...
    def negation_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s) -> bool:
        ...
        return -node_s1.symbol.__eq__(node_s2.symbol)
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        :return: bool
        """
        for node_parent1 in node_s1.parents:
            for node_parent2 in node_s2.parents:
                if not node_parent1.is_mutex(node_parent2):
                    return False
